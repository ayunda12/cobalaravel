...
@section('container')
    <div class="container">
        <h1 class="display-3">Data Peminjaman</h1>
        <p></p>
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header"><b>Data Peminjaman</b></div>
                            ...
                            <tbody>
                                @foreach ($peminjaman as $p)
                                    <tr>
                                        ...
                                        <td>{{ $p->pengembalian ? date('d-m-Y H:i', strtotime($p->pengembalian->created_at)) : 'Belum dikembalikan' }}
                                        </td>
                                        <td>
